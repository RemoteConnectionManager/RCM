...
class ServerAPI:
    ...
    API functions are wrapped by protocol parser to produce the command line interface as well as by
    client rcm_protocol_client to expose a protocol class stub for remote call
    Return data are objects defined in rcm, wrapped currently in pickle and packed on stdout
    """
